...
class Connatix_Widget_Infeed extends WP_Widget {
	...
	public function widget( $args, $instance ) {
        ...
        if($token != "")
            echo "<!-- Generated by Connatix Wordpress Plugin BEGIN --><script type='text/javascript' src='http://cdn.connatix.com/min/connatix.renderer.infeed.min.js' mode='fast' data-connatix-token='".$token."'></script><!-- END Connatix Wordpress Plugin -->";
