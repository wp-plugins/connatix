...
abstract class ConnatixPlugin 
{
   ...
   public function __construct() {
        ...
        add_action('wp_head', array($this,'connatix_head'),1);
    ...
    public function connatix_head()
    {
       ...
       if($valid_page)
       {
            ...
            if($options->_type == 0 && $options->_token != null && strlen($options->_token) > 0)
                echo "<!-- Generated by Connatix Wordpress Plugin --><script type='text/javascript' src='http://cdn.connatix.com/min/connatix.renderer.inpost.connatix.min.js' data-connatix-token='".$options->_token."'></script>";
       }
       ...
       foreach($ad_units as $options)
       {
            if($options != null && $options->_skip_adunit == 0 && $options->_token != null && strlen($options->_token) > 0)
            {
                ...
                foreach($options->_categoryID as $pageID)
                {
                     ...
                     if($valid_page)
                         echo "<!-- Generated by Connatix Wordpress Plugin --><script type='text/javascript' src='http://cdn.connatix.com/min/connatix.renderer.infeed.min.js' data-connatix-token='".$options->_token."'></script>";
                }
             }
       }
    }
