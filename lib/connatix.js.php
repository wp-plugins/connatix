...
class ConnatixJSPlugin extends ConnatixPlugin {
    ...
    private function update_post($dest, $destcode) {
        ...
        $body = "<!--" . ConnatixJSPlugin::$PAGE_NAME . "destpage--><script type='text/javascript' src='//cdn.connatix.com/min/connatix.renderer.destination.min.js'></script>" . $destcode . "<!-- END Destination SCRIPT -->";
