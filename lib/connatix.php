       ...
       foreach($ad_units as $options)
       {
            if($options != null && $options->_skip_adunit == 0 && $options->_token != null && strlen($options->_token) > 0)
            {
                ...
                {   
                     ...
                     if($valid_page){
                        echo "<!-- Generated by Connatix Wordpress Plugin BEGIN --><script type='text/javascript' src='http://cdn.connatix.com/min/connatix.renderer.infeed.min.js' data-connatix-token='".$options->_token."'></script><!-- END Connatix Wordpress Plugin -->";
                        $valid_page = false;
                     }
