...
abstract class ConnatixPlugin 
{
   ...
   public function __construct() {
    ...
    public function filter_connatix_content_alter($content)
    {
       ...
       {
           $script = "<!-- Generated by Connatix Wordpress Plugin BEGIN --><script type='text/javascript' src='http://cdn.connatix.com/min/connatix.renderer.inpost.connatix.min.js' data-connatix-token='".$options->_token."'></script><!-- END Connatix Wordpress Plugin -->";
    ...
    public function connatix_head()
    {
       ...
       if($valid_page)
       {
            ...
            if($options->_type == 0 && $options->_token != null && strlen($options->_token) > 0)
                echo "<!-- Generated by Connatix Wordpress Plugin --><script type='text/javascript' src='http://cdn.connatix.com/min/connatix.renderer.inpost.connatix.min.js' data-connatix-token='".$options->_token."'></script><!-- END Connatix Wordpress Plugin -->";
       }
            ...
            if($options != null && $options->_skip_adunit == 0 && $options->_token != null && strlen($options->_token) > 0)
            {
                ...
                {   
                     ...
                     if($valid_page){
                        ...
                        echo "<!-- Generated by Connatix Wordpress Plugin - ".$options->_name." - BEGIN --><script type='text/javascript' src='http://cdn.connatix.com/min/connatix.renderer.infeed.min.js' data-connatix-token='".$options->_token."'></script><!-- END Connatix Wordpress Plugin -->";
                        $valid_page = false;
                     }
