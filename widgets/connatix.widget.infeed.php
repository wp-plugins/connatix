...
class Connatix_Widget_Infeed extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        if ($token != "") {
            echo "<!-- Generated by Connatix Wordpress Plugin - WIDGET -V: " . CONNATIX_VERSION . " - BEGIN --><script type='text/javascript' src='//cdn.connatix.com/min/connatix.renderer.infeed.min.js' mode='fast' data-connatix-token='" . $options->_token . "' async></script><!-- END Connatix Wordpress Plugin -->";
        }
